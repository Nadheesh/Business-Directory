      ...
      populateToolbar: function(toolbar) {
        ...
        buttonize = function(type) {
          ...
          button.on("click", function(event) {
            ...
            //added to set the position of the dialog near the button
            dialog.dialog("option", "position", { my: "center", at: "center", of:button, collision: "fit"});
  ...
  (function(jQuery) {
    return jQuery.widget('IKS.halloindicator', {
      ...
      buildIndicator: function() {
        var editButton;
        editButton = jQuery('<div><i class="fa-edit"></i> Edit</div>');
